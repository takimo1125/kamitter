    ...
    <div class="l-contents">
        ...
        <div class="p-contents__area--narrow">
            <section class="c-title">
                <h2 class="c-title__head">Twitterアカウント一覧</h2>
                <span class="c-title__description">最大１０アカウントまで登録できます。</span>
            </section>
            <h2 class="p-contents__head"><i class="c-icon--twitter fab fa-twitter"></i>利用するTwitterアカウントを選択してください</h2>
