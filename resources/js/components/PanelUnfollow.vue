<template>
    <div class="c-panel u-color__bg--white">
        ...
        <p class="p-dashboard__notion">※ 自動アンフォロー機能でアンフォローするアカウントは、自動フォローでフォローしたアカウントから「7日以内にフォロー返ししてくれないユーザー」と「15日ツイートを投稿していないユーザー」の条件に該当するアカウントで、アンフォローリストを作成し、自動でアンフォローします。</p><br />
