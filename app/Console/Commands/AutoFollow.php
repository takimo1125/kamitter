...
class AutoFollow extends Command
{
     ...
     * @var string
     */
    protected $description = 'Twitter APIでのオートフォロー機能';
     ...
     * フォロー後にフォロワーターゲットリストからフォローヒストリーにデータを移す。
     */
    public function handle()
    {
        ...
        foreach ($auto_follow_running_status_list as $auto_follow_running_status_item) {
             ...
             * ターゲットリストの作成
             */
            //最後に作成されたフォロワーターゲットリストのcursorを見て
            ...
            //フォロワーターゲットリストが未作成または作成途中の場合はリストを作成する
